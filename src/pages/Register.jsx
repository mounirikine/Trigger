...
import Icon from '../assets/left.jpg';
import Logo2 from '../assets/logo2.png';

const Register = () => {
  return (
    <section className="min-h-screen flex">
      <div className="w-7/12 h-screen bg-blue-700 object-cover hidden lg:flex items-center justify-center">
              ...
              <div>
                ...
                <div className="mt-2">
                  <input
                    ...
                    required
                    className="block w-full px-4 outline-none rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                  />
                </div>
              </div>
              <div>
